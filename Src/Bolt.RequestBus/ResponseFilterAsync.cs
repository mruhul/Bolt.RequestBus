...
namespace Bolt.RequestBus
{
    ...
    {
        Task Filter(IExecutionContext context, IResponse<TResult> response);
    }

    public abstract class ResponseFilterAsync<TResult> : IResponseFilterAsync<TResult>
    {
        public abstract Task Filter(IExecutionContext context, IResponse<TResult> response);
    ...
    {
        Task Filter(IExecutionContext context, ICollection<IResponseUnit<TResult>> responses);
    }

    public abstract class ResponseCollectionFilterAsync<TResult> : IResponseCollectionFilterAsync<TResult>
    {
        public abstract Task Filter(IExecutionContext context, ICollection<IResponseUnit<TResult>> responses);
    ...
    {
        Task Filter(IExecutionContext context, TRequest request, IResponse<TResult> response);
    }

    public abstract class ResponseFilterAsync<TRequest, TResult> : IResponseFilterAsync<TRequest, TResult>
    {
        public abstract Task Filter(IExecutionContext context, TRequest request, IResponse<TResult> response);
    ...
    {
        Task Filter(IExecutionContext context, TRequest request, ICollection<IResponseUnit<TResult>> responses);
    }

    public abstract class ResponseCollectionFilterAsync<TRequest, TResult> : IResponseCollectionFilterAsync<TRequest, TResult>
    {
        public abstract Task Filter(IExecutionContext context, TRequest request, ICollection<IResponseUnit<TResult>> responses);
